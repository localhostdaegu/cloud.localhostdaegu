...
- 반영(2026-09-17): §5 질문 1·2·4·6 사용자 결정대로 운영 파일에 반영(null 금리는 카드에서 "은행별 상이", youth-3/4 현 위치 유지, 전국 상품 포함, 업종 id 통일). 질문 3은 youth-1 `[]` 유지, 질문 5는 matcher가 `owner_age` 미수집 시 연령 조건을 건너뛰도록 수정, 질문 7은 범위 밖.
