...
- 해커톤 프로젝트: **2026 AI Blockchain Challenge in Daegu** (iM뱅크 주최, 소상공인·골목상권 디지털 금융 트랙, 접수 마감 2026-09-20). 상세: `docs/2026_AI_Blockchain_Challenge_Daegu.md`
- 서비스 도메인: **localhostdaegu.cloud** (이 저장소)
- 지킬(블로그/허브) 도메인: **053.localhostdaegu.cloud** — 별도 저장소 `~/projects/053.localhostdaegu.cloud`

## Project-specific instructions

- `backend/` 작업 시 `backend/CLAUDE.md`를 함께 따릅니다.
- `frontend/` 작업 시 `frontend/CLAUDE.md`를 함께 따릅니다.

## Local ports

- 백엔드 서버: **8300** (http://localhost:8300)
- 프론트엔드 dev 서버: **3300** (http://localhost:3300)
- 데이터 스토어 (`docker-compose.yml`, 127.0.0.1 전용): Postgres/pgvector **5437**, Neo4j **7476**(HTTP)/**7689**(Bolt), Redis **6381**
