...
- Hackathon project: **2026 AI Blockchain Challenge in Daegu** (iM뱅크 주최, 소상공인·골목상권 디지털 금융 트랙, 접수 마감 2026-09-20). Details: `docs/2026_AI_Blockchain_Challenge_Daegu.md`
- Service domain: **localhostdaegu.cloud** (this repo)
- Jekyll (blog/hub) domain: **053.localhostdaegu.cloud** — separate repo at `~/projects/053.localhostdaegu.cloud`

## Project-specific instructions

- Before changing files under `backend/`, read and follow `backend/AGENTS.md`.
- Before changing files under `frontend/`, read and follow `frontend/AGENTS.md`.
- When a task spans both areas, apply both instruction files within their respective scopes.

## Local ports

- Backend server: **8300** (http://localhost:8300)
- Frontend dev server: **3300** (http://localhost:3300)
- Data stores (`docker-compose.yml`, 127.0.0.1 only): Postgres/pgvector **5437**, Neo4j **7476** (HTTP) / **7689** (Bolt), Redis **6381**
